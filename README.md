...
- **Asistencia por clase**: el profesor oprime "Iniciar clase" en su grupo cuando la clase empieza —queda registrada la hora real— y marca ahí mismo quién asistió, quién faltó y quién faltó con excusa. Solo él la escribe: director y administrador ven el registro sin poder modificarlo. Cada grupo tiene su propia pantalla de clases dictadas, con el conteo de cada sesión y el porcentaje de asistencia de cada estudiante.
